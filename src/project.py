...
# Set where the image will start in the Minecraft world (X and Z coordinates)
ORIGIN_X = 0
ORIGIN_Z = 0

# Color map: RGB -> (block_id, block_data)
COLOR_MAP = {
    # Wool
...
def closest_block(rgb):
    ...
    best_block = (block.STONE.id, 0)  # default
...
def build_image_in_minecraft(image_path, width_in_blocks, start_y):
...
if __name__ == "__main__":
    ...
    build_image_in_minecraft(image_path, width_in_blocks, start_y)
